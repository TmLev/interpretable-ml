...
def _get_page_header():
    header = html.Header([
        ...
        html.P("В современном мире машинное обучение способно решать целый спектр разнообразных задач:"
    ...
    sections = [
        ...
        html.Div(html.Div([
            ...
            html.Details([
                ...
                html.P(
                    "Желающих поэкспериментировать ещё ожидает целый раздел в самом конце."
                ),
            ]),
            html.P([
        ...
        html.Div(html.Div([
            html.H3("Выжимаем все соки"),

            html.Details([
                html.Summary("Фреш для смелых духом"),
                ""
